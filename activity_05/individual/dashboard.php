    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <?php if ($userRole === 'student'): ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                ...
                <a href="join_session.php" class="card-hover bg-gradient-to-br from-green-500 to-green-600 text-white rounded-lg shadow-lg p-6">
                    <i class="fas fa-signal text-4xl mb-4"></i>
                    <h3 class="text-xl font-bold mb-2">Join Live Sessions</h3>
                    <p class="text-sm opacity-90">Mark attendance with session codes</p>
                </a>
            </div>
                ...
                <div class="bg-white rounded-lg shadow-lg p-6 border-l-4 border-green-500">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-800"><?php echo count($enrolledCourses); ?></p>
                            <p class="text-sm text-gray-500 mt-1">Currently enrolled</p>
                        </div>
                        <i class="fas fa-book text-5xl text-green-500"></i>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-lg p-6 border-l-4 border-yellow-500">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-800"><?php echo $pendingRequestsCount; ?></p>
        ...
        <?php elseif ($userRole === 'faculty'): ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                ...
                <a href="active_sessions.php" class="card-hover bg-gradient-to-br from-green-500 to-green-600 text-white rounded-lg shadow-lg p-6">
                    <i class="fas fa-broadcast-tower text-4xl mb-4"></i>
                    <h3 class="text-xl font-bold mb-2">Start Live Session</h3>
                    <p class="text-sm opacity-90">Create attendance sessions with codes</p>
                </a>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div class="bg-white rounded-lg shadow-lg p-6 border-l-4 border-yellow-500">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-gray-600 text-sm">Pending Requests</p>
                            <p class="text-3xl font-bold text-gray-800"><?php echo $pendingRequestsCount; ?></p>
                            <p class="text-sm text-gray-500 mt-1">Requests to review</p>
                        </div>
                        <i class="fas fa-tasks text-5xl text-yellow-500"></i>
                    </div>
                    <a href="manage_requests.php" class="mt-4 inline-block text-yellow-600 hover:text-yellow-700 font-semibold">
                ...
                <div class="bg-white rounded-lg shadow-lg p-6 border-l-4 border-green-500">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-gray-600 text-sm">My Courses</p>
                            <p class="text-3xl font-bold text-gray-800"><?php echo count($facultyCourses); ?></p>
                            <p class="text-sm text-gray-500 mt-1">Courses teaching</p>
                        </div>
                        <i class="fas fa-chalkboard text-5xl text-green-500"></i>
                    </div>
                </div>
            </div>
